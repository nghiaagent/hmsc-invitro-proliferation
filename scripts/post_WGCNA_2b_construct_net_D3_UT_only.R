...
load(file = "./output/data_WGCNA/WGCNA_D3_UT/GCN_input.Rdata")

# Construct GCN

GCN$net <- blockwiseModules(datExpr = GCN$E,
...
png(
  "./output/plots_WGCNA/WGCNA_D3_UT/GCN dendrogram.png",
  res = 150,
  width = 40,
  height = 20,
  units = "cm"
...
MEs_plot <- moduleEigengenes(GCN$E,
                             labels2colors(GCN$net$colors))$eigengenes %>%
  orderMEs()
...
png(
  "./output/plots_WGCNA/WGCNA_D3_UT/Correlation of module PC1s to variables.png",
  res = 150,
  width = 30,
  height = 30,
  units = "cm"
...
save(GCN, file = "./output/data_WGCNA/WGCNA_D3_UT/GCN_output.RData")