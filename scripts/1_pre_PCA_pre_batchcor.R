...
ggsave(
    filename = "./output/plots_PCA_prebatchcorrection/conditionPCA.png",
    plot = plot_PCA1_2,
    width = 8,
    height = 12,
    scale = 0.7
...
ggsave(
    filename = "./output/plots_PCA_prebatchcorrection/batchPCA.png",
    plot = plot_PCA3_8,
    width = 8,
    height = 8,
    scale = 1.7
...
ggsave(
    filename = "./output/plots_PCA_prebatchcorrection/cell_linePCA.png",
    plot = plot_PCA2_3,
    width = 8,
    height = 8,
    scale = 1.7
...
ggsave(
    filename = "./output/plots_PCA_prebatchcorrection/passagePCA.png",
    plot = plot_PCA4_7,
    width = 8,
    height = 8,
    scale = 1.7
...
ggsave(
    filename = "./output/plots_PCA_prebatchcorrection/PCAcorrelation.png",
...
ggsave(
    filename = "./output/plots_PCA_prebatchcorrection/PCAloadings.png",
...
ggsave(
    filename = "./output/plots_PCA_prebatchcorrection/PCApairs_batch.png",
...
ggsave(
    filename = "./output/plots_PCA_prebatchcorrection/PCApairs_cell_pop.png",
...
ggsave(
    filename = "./output/plots_PCA_prebatchcorrection/PCApairs_Passage.png",
...
ggsave(
    filename = "./output/plots_PCA_prebatchcorrection/PCApairs_Treatment.png",
