...
# Select D3 UT samples

x <- quant_DGE_voom[, quant_DGE_voom$targets$Day == "D3" &
...
png(
  "./output/plots_WGCNA/WGCNA_D3_UT/Sample clustering.png",
  res = 150,
  width = 40,
  height = 25,
  units = "cm"
...
png(
  "./output/plots_WGCNA/WGCNA_D3_UT/Soft thresholding index selection.png",
  res = 150,
  width = 40,
  height = 20,
  units = "cm"
...
save(GCN,
     file = "./output/data_WGCNA/WGCNA_D3_UT/GCN_input.Rdata")
