...
quant_DGE_clean <-
  readRDS(file = "./output/data_expression/pre_DGE/quant_refseq_DGEList_filter.RDS")
...
png(
  "./output/plots_QC/voom mean-variance trend RefSeq.png",
  width = 18,
  height = 12,
  units = 'cm',
  res = 400
...
saveRDS(fit_contrasts,
        file = "./output/data_expression/post_DGE/fit_contrasts_refseq.RDS")