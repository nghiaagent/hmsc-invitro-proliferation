...
pca <- PCAtools::pca(
    mat = quant_DGE_batchcor_withcellpop$counts,
...
plot_loadings <- PCAtools::plotloadings(
    pca,
...
plot_PCA2_4 <- PCAtools::biplot(pca,
    ...
    encircle = TRUE,
    encircleFill = TRUE,
    title = "Differences between cell populations captured by PC 2 and 4",
    legendPosition = "bottom"
)

plot_PCA3_5 <- PCAtools::biplot(pca,
    x = "PC5",
    y = "PC3",
    lab = NULL,
    showLoadings = TRUE,
    ...
    encircle = TRUE,
    encircleFill = TRUE,
    title = "Difference between growth phases captured by PC 3 and 5",
    legendPosition = "bottom"
)

plot_PCA7_10 <- PCAtools::biplot(pca,
    x = "PC10",
    y = "PC7",
    lab = NULL,
    showLoadings = TRUE,
    ...
    encircle = TRUE,
    encircleFill = TRUE,
    title = "Difference between treatments captured by PC 7 and 10",
    legendPosition = "bottom"
)
...
ggsave(
    filename = "./output/plots_PCA_postbatchcorrection/conditionPCA.png",
    plot = plot_PCA1_2,
    width = 8,
    height = 12,
    scale = 0.7
...
ggsave(
    filename = "./output/plots_PCA_postbatchcorrection/cell_linePCA.png",
    plot = plot_PCA2_4,
    width = 8,
    height = 8,
    scale = 1.7
...
ggsave(
    filename = "./output/plots_PCA_postbatchcorrection/passagePCA.png",
    plot = plot_PCA3_5,
    width = 8,
    height = 8,
    scale = 1.7
...
ggsave(
    filename = "./output/plots_PCA_postbatchcorrection/TreatmentPCA.png",
    plot = plot_PCA7_10,
    width = 8,
    height = 8,
    scale = 1.7
...
ggsave(
    filename = "./output/plots_PCA_postbatchcorrection/PCAcorrelation.png",
...
ggsave(
    filename = "./output/plots_PCA_postbatchcorrection/PCAloadings.png",
...
ggsave(
    filename = "./output/plots_PCA_postbatchcorrection/PCApairs_batch.png",
...
ggsave(
    filename = "./output/plots_PCA_postbatchcorrection/PCApairs_cell_pop.png",
...
ggsave(
    filename = "./output/plots_PCA_postbatchcorrection/PCApairs_Passage.png",
...
ggsave(
    filename = "./output/plots_PCA_postbatchcorrection/PCApairs_Treatment.png",
