...
Single sample gene set enrichment analysis using GSVA was used to quantify pathway activity within each sample. Statistical analysis using limma was then used to determine activity changes between D5 and D3 at each treatment and hMSC growth phase. Results for Phase A / P+5 and Phase B / P+7 are plotted.
...
vennDiagram(decideTests(fit_GSVA$GOBP)[,c(7,10)],
            include = c("up",
                        "down"),
            names = c("Untreated",
                      "Treated"),
...
vennDiagram(decideTests(fit_GSVA$GOCC)[,c(7,10)],
            include = c("up",
                        "down"),
            names = c("Untreated",
                      "Treated"),
...
vennDiagram(decideTests(fit_GSVA$GOMF)[,c(7,10)],
            include = c("up",
                        "down"),
            names = c("Untreated",
                      "Treated"),
...
vennDiagram(decideTests(fit_GSVA$h)[,c(7,10)],
            include = c("up",
                        "down"),
            names = c("Untreated",
                      "Treated"),
...
vennDiagram(decideTests(fit_GSVA$c2)[,c(7,10)],
            include = c("up",
                        "down"),
            names = c("Untreated",
                      "Treated"),
...
vennDiagram(decideTests(fit_GSVA$c3)[,c(7,10)],
            include = c("up",
                        "down"),
            names = c("Untreated",
                      "Treated"),
...
vennDiagram(decideTests(fit_GSVA$Reactome)[,c(7,10)],
            include = c("up",
                        "down"),
            names = c("Untreated",
                      "Treated"),
...
glimmaVolcano(fit_GSVA$Reactome,
              coef = 10)
...
vennDiagram(decideTests(fit_GSVA$KEGG)[,c(7,10)],
            include = c("up",
                        "down"),
            names = c("Untreated",
                      "Treated"),
...
vennDiagram(decideTests(fit_GSVA$GOBP)[,c(8,11)],
            include = c("up",
                        "down"),
            names = c("Untreated",
                      "Treated"),
...
vennDiagram(decideTests(fit_GSVA$GOCC)[,c(8,11)],
            include = c("up",
                        "down"),
            names = c("Untreated",
                      "Treated"),
...
vennDiagram(decideTests(fit_GSVA$GOMF)[,c(8,11)],
            include = c("up",
                        "down"),
            names = c("Untreated",
                      "Treated"),
...
vennDiagram(decideTests(fit_GSVA$h)[,c(8,11)],
            include = c("up",
                        "down"),
            names = c("Untreated",
                      "Treated"),
...
vennDiagram(decideTests(fit_GSVA$c2)[,c(8,11)],
            include = c("up",
                        "down"),
            names = c("Untreated",
                      "Treated"),
...
vennDiagram(decideTests(fit_GSVA$c3)[,c(8,11)],
            include = c("up",
                        "down"),
            names = c("Untreated",
                      "Treated"),
...
vennDiagram(decideTests(fit_GSVA$Reactome)[,c(8,11)],
            include = c("up",
                        "down"),
            names = c("Untreated",
                      "Treated"),
...
vennDiagram(decideTests(fit_GSVA$KEGG)[,c(8,11)],
            include = c("up",
                        "down"),
            names = c("Untreated",
                      "Treated"),
